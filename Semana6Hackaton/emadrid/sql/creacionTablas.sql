...
CREATE SCHEMA IF NOT EXISTS `hackatons6emadrid` DEFAULT CHARACTER SET utf8 ;

CREATE TABLE IF NOT EXISTS `hackatons6emadrid`.`facCabecera` (
  ...
  CONSTRAINT `fk_facCabecera_empresa1`
    ...
    REFERENCES `hackatons6emadrid`.`empresa` (`idempresa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facCabecera_tipoPago1`
    FOREIGN KEY (`idtipoPago`)
    REFERENCES `hackatons6emadrid`.`tipoPago` (`idtipoPago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facCabecera_clientes1`
    FOREIGN KEY (`idcliente`)
    REFERENCES `hackatons6emadrid`.`clientes` (`idcliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `hackatons6emadrid`.`productos` (
...
CREATE TABLE IF NOT EXISTS `hackatons6emadrid`.`facDetalle` (
  ...
  CONSTRAINT `fk_facDetalle_facCabecera`
    ...
    REFERENCES `hackatons6emadrid`.`facCabecera` (`idfacCabecera`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facDetalle_productos1`
    FOREIGN KEY (`idproducto`)
    REFERENCES `hackatons6emadrid`.`productos` (`idproducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `hackatons6emadrid`.`empresa` (
...
CREATE TABLE IF NOT EXISTS `hackatons6emadrid`.`tipoPago` (
...
CREATE TABLE IF NOT EXISTS `hackatons6emadrid`.`clientes` (
