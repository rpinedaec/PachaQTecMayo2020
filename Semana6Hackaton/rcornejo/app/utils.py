...
class Menu:
    ...
    def mostrarMenu(self):
        ...
        while(opSalir):
            self.limpiarPantalla()
            print('\033[3;34;47m'+':::::::::::::BIENVENIDOS A LA EMPRESA::::::::::::::'+'\033[0;m')
            ...
            print("\033[1;34m"+"...................................................."+'\033[0;m')
            try:
                print(color.CYAN+"Digita aquí debajo tu opción:"+color.CEND)
                opcion = int(input())
            except ValueError as error:
                self.__log.error(error)
                print(color.RED+"¡Opción inválida! Deben ser numeros del 0 al 2"+color.CEND)
            contOpciones = 0
            for (key, value) in self.listaOpciones.items():
                if(opcion == int(value) or opcion == 9):
                   contOpciones += 1
            if(contOpciones == 0):
                print(color.RED+"Escoge una opción válida"+color.CEND)
