...
CREATE SCHEMA IF NOT EXISTS `hackatons6sperez` DEFAULT CHARACTER SET utf8 ;

CREATE TABLE IF NOT EXISTS `hackatons6sperez`.`facCabecera` (
  ...
  CONSTRAINT `fk_facCabecera_empresa1`
    ...
    REFERENCES `hackatons6sperez`.`empresa` (`idempresa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facCabecera_tipoPago1`
    FOREIGN KEY (`idtipoPago`)
    REFERENCES `hackatons6sperez`.`tipoPago` (`idtipoPago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facCabecera_clientes1`
    FOREIGN KEY (`idcliente`)
    REFERENCES `hackatons6sperez`.`clientes` (`idcliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `hackatons6sperez`.`productos` (
...
CREATE TABLE IF NOT EXISTS `hackatons6sperez`.`facDetalle` (
  ...
  CONSTRAINT `fk_facDetalle_facCabecera`
    ...
    REFERENCES `hackatons6sperez`.`facCabecera` (`idfacCabecera`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facDetalle_productos1`
    FOREIGN KEY (`idproducto`)
    REFERENCES `hackatons6sperez`.`productos` (`idproducto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `hackatons6sperez`.`empresa` (
...
CREATE TABLE IF NOT EXISTS `hackatons6sperez`.`tipoPago` (
...
CREATE TABLE IF NOT EXISTS `hackatons6sperez`.`clientes` (
