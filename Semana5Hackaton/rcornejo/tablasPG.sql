...
(
    ...
    CONSTRAINT fk_curso_profesor1 FOREIGN KEY (idprofesor)
...
(
    ...
    CONSTRAINT fk_salon_alumno1 FOREIGN KEY (idalumno)
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_salon_profesor FOREIGN KEY (idprofesor)
        REFERENCES public.profesor (idprofesor) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    dessemestre character varying(45) COLLATE pg_catalog."default" NOT NULL,
