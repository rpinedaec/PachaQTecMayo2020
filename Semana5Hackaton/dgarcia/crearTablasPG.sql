...
(
    ...
    nombrealumno character varying COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    nombresalron character varying(45) COLLATE pg_catalog."default" NOT NULL,
    idalumno integer NOT NULL,
    idprofesor integer NOT NULL,
