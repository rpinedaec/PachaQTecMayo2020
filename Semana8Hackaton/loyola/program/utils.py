...
class Menu:
    ...
    def mostrarMenu(self):
        ...
        while(opSalir):
            self.limpiarPantalla()
            print(color.YELLOW+":::::::::::::::::::BIENVENIDOS:::::::::::::::::::"+color.CEND)
            print(color.YELLOW+":::::::::::::::::::" +self.nombreMenu + "::::::::::::::::::"+color.CEND)
            ...
            print("\t- Salir \t\t::  9")
            try:
                print(color.YELLOW+"Escoge tu opcion"+color.CEND)
                opcion = int(input())
            except ValueError as error:
                self.__log.error(error)
                print(color.RED+"Opcion invalida"+color.CEND)
            contOpciones = 0
            for (key, value) in self.listaOpciones.items():
