...
def showCliente(lst):
    while True:
        print(157*"-")
        print(f'|{"DNI":^25}|{"Nombre":^25}|{"Apellido":^25}|{"Edad":^25}|{"Sexo":^25}|{"CodCliente":^25}|')
        print(157*"-")
        for i in lst:
            dni = getattr(i,"dni")
...
def showEmpleado(lst):
    while True:
        print(157*"-")
        print(f'|{"DNI":^25}|{"Nombre":^25}|{"Apellido":^25}|{"Edad":^25}|{"Sexo":^25}|{"CodEmpleado":^25}|')
        print(157*"-")
        for i in lst:
            dni = getattr(i,"dni")
            nombre = getattr(i,"nombre")
    ...
    while True:
        try:
            if len(lst) > 0 :
                ...
                print(105*"-")
                #Elimar
                codProducto = int(input("Ingrese el codigo del Producto a eliminar: "))
                if search(codProducto,"codProducto",lst):
                    strConfirmation = input(f"Esta seguro de eliminar el item {codProducto} S/N: ")
                    if strConfirmation == "S":
                        for i,x in enumerate(lst):
                            if getattr(x,"codProducto") == codProducto:
                                del lst[i]
                        print("Item eliminado correctamente")
                        c = input("Producto eliminado, ingrese cualquier tecla para continuar: ")
                        break
                    elif strConfirmation == "N":
                        c = input("No se eliminara ningun producto, ingrese cualquier tecla para continuar: ")
                        break
                    else:
                        print("Ingrese S o N")
                else:
                    c = input ("El producto no existe, ingrese cualquier tecla para continuar")
            else:
                c = input("Aún no se ah registrado ningun producto, ingrese cualquier tecla para continuar")
                break
        except :
...
def valProducto(lst):
    ...
    if len(lst) > 0:
        print(131*"-")
        print(f'|{"codProducto":^25}|{"Nombre":^25}|{"Cantidad":^25}|{"Costo":^25}|{"Valor producto":^25}|')
        print(131*"-")
        for i in lst:
            cod = getattr(i,"codProducto")
            nombre = getattr(i,"nombreProducto")
        ...
        c = input("Aun no se han agregado productos,ingrese cualquier tecla para continuar: ")
