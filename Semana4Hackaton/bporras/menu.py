...
MenuPrincipal= Menu({   1:"Cliente",            2:"Empleado",           3:"Producto"},                                          "VENTAS GROUP S.A.", "Menú Principal")
MenuEmpleado= Menu({    1:"Crear empleado",     2:"Ver empleado",       3:"Validar existencia"},                                "VENTAS GROUP S.A.", "Menú Empleado")
MenuCliente= Menu({     1:"Crear cliente",      2:"Ver cliente",        3:"Validar existencia"},                                "VENTAS GROUP S.A.", "Menú Cliente")
MenuProducto= Menu({    1:"Agregar producto",   2:"Quitar Producto",    3:"Listar/Contar Producto", 4:"Valorizar productos"},   "VENTAS GROUP S.A.", "Menú Producto")                   
        ...
        while True:
            ...
            if intOptionSelect == 1:        #Crear Cliente
                ...
                if search(getattr(newclient,"dni"),"dni",lstClientes):
                    strExiste = input ("El cliente ya existe, ¿Desea reemplazarlo? S/N: ")
                    if strExiste == "S":
                ...
                while True:
                    try:
                        if search(int(input("Ingrese el numero de dni: ")),"dni",lstClientes):
                            ...
                            c = input("Ingrese cualquier valor para continua: ")
                            break
                        else:
        ...
        while True:
            ...
            if intOptionSelect == 1:        #Crear Empleado
                ...
                if search(getattr(newempleado,"dni"),"dni",lstEmpleados):
                    strExiste = input ("El empleado ya existe, ¿Desea reemplazarlo? S/N: ")
                    if strExiste == "S":
                ...
                while True:
                    try:
                        if search(int(input("Ingrese el numero de dni: ")),"dni",lstEmpleados):
                            ...
                            c = input("Ingrese cualquier valor para continuar: ")
                            break
                        else:
