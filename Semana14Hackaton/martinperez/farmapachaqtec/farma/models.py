...
class producto(models.Model):
    ACTIVO = 'AC'
    INACTIVO = 'IA'
    CHOICE = [(True,'GENERICO'),(False,'COMERCIAL')]  
    nombre = models.CharField(max_length=200)
    tipoproducto = models.ForeignKey(tipoProducto, on_delete=models.CASCADE)
    igv = models.BooleanField()
    costo = models.DecimalField(max_digits=10,decimal_places=2)
    isGenerico = models.BooleanField(choices=CHOICE,default=True, blank=False)
    ingredienteActivo = models.CharField(max_length=200,default="")
